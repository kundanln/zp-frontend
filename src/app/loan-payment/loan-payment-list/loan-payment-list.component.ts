...
export class LoanPaymentListComponent implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute,private zpSevice: ZPService, private loanPaymentService : LoanPaymentService ) { 
    ...
    {headerName:"तालुका",field:'taluka',filter:'agTextColumnFilter', width: 270},
    {headerName:"गावाचे नाव",field:'villageName',filter:'agTextColumnFilter', width: 270},
    {headerName:"कामाचा तपशील",field:'workParticulars',filter:'agTextColumnFilter', width: 270},
    ...
    {headerName:"कर्जाची मंजूर रक्कम",field:'loanBalance',filter:'agTextColumnFilter', width: 270}
    ];
