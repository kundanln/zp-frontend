...
export class ZpAddComponent implements OnInit {
  ...
  addUpdateZPMaster() {
    ...
    if (this.button == 'Add') {
      ...
      //   }
      // });
      this.model.balance = this.model.loanAmount;
      this.model.loanBalance = this.model.loanAmount;
      this.zpService.create(this.model).subscribe(() => {
        ...
        error => {
          alert("Zp Master Record not Added");
          throw error;
        });
      ...
      this.zpService.update(this.model).subscribe(() => {
        ...
        error => {
          alert("Zp Master Record not Updated");
          throw error;
        });
    }
